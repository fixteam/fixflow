 ...
 * <ul>
 *   <li>{@link com.founder.fix.bpmn2extensions.connector.impl.PagesImpl#getPage <em>Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PagesImpl extends EObjectImpl implements Pages {
	...
	protected EClass eStaticClass() {
		return ConnectorPackage.Literals.PAGES;
	}
	...
	public EList<Page> getPage() {
		if (page == null) {
			page = new EObjectContainmentEList<Page>(Page.class, this, ConnectorPackage.PAGES__PAGE);
		}
		return page;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConnectorPackage.PAGES__PAGE:
