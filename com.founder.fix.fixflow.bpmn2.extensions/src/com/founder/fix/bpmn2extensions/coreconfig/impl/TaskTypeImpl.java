 ...
 * <ul>
 *   <li>{@link com.founder.fix.bpmn2extensions.coreconfig.impl.TaskTypeImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link com.founder.fix.bpmn2extensions.coreconfig.impl.TaskTypeImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaskTypeImpl extends EObjectImpl implements TaskType {
	...
	protected EClass eStaticClass() {
		return CoreconfigPackage.Literals.TASK_TYPE;
	}
	...
	public void setTypeId(String newTypeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoreconfigPackage.TASK_TYPE__TYPE_ID, oldTypeId, typeId));
	}
	...
	public void setTypeName(String newTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoreconfigPackage.TASK_TYPE__TYPE_NAME, oldTypeName, typeName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoreconfigPackage.TASK_TYPE__TYPE_ID:
				return getTypeId();
			case CoreconfigPackage.TASK_TYPE__TYPE_NAME:
				return getTypeName();
		}
