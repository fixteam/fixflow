package com.founder.fix.fixflow.expand.connector.AutoSendMail;
...
public class AutoSendMail implements ConnectorHandler {
	...
	public void execute(ExecutionContext executionContext) throws Exception {
		...
		try {
			...
			String taskUrl = "http://146.91.78.40:82/fixweb/";
			...
			taskUrl = "http://127.0.0.1:8080/fixweb/framework.html?" + "_openMethod=tab&_title=view&_url='../../"
			...
			if (taskInstance.getAssignee() != null) {
				...
				if (!to.equals("")) {
					...
					if (userTo != null) {
						...
						if (eamil != null && !eamil.equals("")) {
							sendMail(eamil, mailTitle, mailContent);
						}
					}
				}
				...
				if (!to.equals("")) {
					...
					sendMail(to, mailTitle, mailContent);
				}
	...
	private void sendMail(String to, String title, String mailContent) {
