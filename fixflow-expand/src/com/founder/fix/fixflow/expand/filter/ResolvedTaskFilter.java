...
public class ResolvedTaskFilter extends AbstractCommandFilter {
	...
	public boolean accept(TaskInstance taskInstance) {
		...
		if(!taskInstance.hasEnded()&&taskInstance.getAssignee()!=null&&taskInstance.getDelegationState()!=null&&taskInstance.getDelegationState().equals(DelegationState.RESOLVED)&&!taskInstance.isSuspended()){
			return true;
		}
		else{
			return false;
