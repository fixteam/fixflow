...
public class ConnectorInstanceElm implements EditorJsonConstants, StencilConstants{
	...
	public ObjectNode convertElementToJson(BaseElementImpl baseElm) throws InstantiationException, IllegalAccessException{
	      ...
	      return ObjectNode.class.newInstance();
	}
	
	public List<ConnectorInstance> convertJsonToElement(JsonNode elementNode) throws JsonProcessingException, IOException {
