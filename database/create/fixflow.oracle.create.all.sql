...
ALTER TABLE FIXFLOW_HIS_TASKINSTANCE
  ...
  ;
CREATE INDEX FIXFLOW_HIS_TASKINSTANCE_ISBLOCKING_IDX ON FIXFLOW_HIS_TASKINSTANCE (ISBLOCKING)
;
CREATE INDEX FIXFLOW_HIS_TASKINSTANCE_PROCESSINSTANCE_ID ON FIXFLOW_HIS_TASKINSTANCE (PROCESSINSTANCE_ID)
;
CREATE INDEX FIXFLOW_HIS_TASKINSTANCE_ASSIGNEE ON FIXFLOW_HIS_TASKINSTANCE (ASSIGNEE)
;
CREATE INDEX FIXFLOW_HIS_TASKINSTANCE_CREATE_TIME ON FIXFLOW_HIS_TASKINSTANCE (CREATE_TIME)
;
...
ALTER TABLE FIXFLOW_HIS_TOKEN
  ...
  ;
CREATE INDEX FIXFLOW_HIS_TOKEN_PROCESSINSTANCE_ID ON FIXFLOW_HIS_TOKEN (PROCESSINSTANCE_ID)
;
...
COMMENT ON COLUMN FIXFLOW_HIS_VARIABLE.VARIABLE_VALUE
  IS '变量VALUE'
  ;
CREATE INDEX FIXFLOW_HIS_VARIABLE_PROCESSINSTANCE_ID ON FIXFLOW_HIS_VARIABLE (PROCESSINSTANCE_ID)
;
