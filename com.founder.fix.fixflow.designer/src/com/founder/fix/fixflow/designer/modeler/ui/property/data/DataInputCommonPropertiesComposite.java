...
public class DataInputCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;


	public DataInputCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public DataInputCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
