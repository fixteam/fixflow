...
public class LaneCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public LaneCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public LaneCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
