...
public class EventBasedGatewayCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public EventBasedGatewayCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public EventBasedGatewayCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
