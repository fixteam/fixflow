...
public class ReceiveTaskCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public ReceiveTaskCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	

	public ReceiveTaskCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
