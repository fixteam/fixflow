...
public class IntermediateThrowEventCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public IntermediateThrowEventCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public IntermediateThrowEventCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
