...
public class InclusiveGatewayCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public InclusiveGatewayCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public InclusiveGatewayCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
