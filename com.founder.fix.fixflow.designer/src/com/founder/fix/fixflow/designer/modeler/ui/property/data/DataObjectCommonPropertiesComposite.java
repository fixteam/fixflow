...
public class DataObjectCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public DataObjectCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public DataObjectCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
	...
	public void createUI() {
		...
		Label descLabel = new Label(this, SWT.BORDER | SWT.WRAP);
