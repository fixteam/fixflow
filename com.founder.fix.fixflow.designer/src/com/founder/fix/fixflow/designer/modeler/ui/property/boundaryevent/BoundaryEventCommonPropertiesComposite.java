...
public class BoundaryEventCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	...
	public BoundaryEventCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public BoundaryEventCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
	...
	public void createUIBindings(EObject eObject) {
		...
		final BoundaryEvent boundaryEvent=(BoundaryEvent)be;
