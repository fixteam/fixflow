...
public class ExclusiveGatewayCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;
	public ExclusiveGatewayCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public ExclusiveGatewayCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
