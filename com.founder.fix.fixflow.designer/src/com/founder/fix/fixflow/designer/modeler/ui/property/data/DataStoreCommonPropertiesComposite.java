...
public class DataStoreCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;
	public DataStoreCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public DataStoreCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
