package com.founder.fix.fixflow.designer.modeler.ui.property.intermediatecatchevent;
...
public class IntermediateCatchEventCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;
	public IntermediateCatchEventCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public IntermediateCatchEventCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
