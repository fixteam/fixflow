package com.founder.fix.fixflow.designer.modeler.ui.property.endevent;
...
public class EndEventCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public EndEventCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public EndEventCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
