...
public class DataOutputCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public DataOutputCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public DataOutputCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
