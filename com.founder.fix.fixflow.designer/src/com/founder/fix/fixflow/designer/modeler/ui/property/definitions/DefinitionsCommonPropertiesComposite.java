...
public class DefinitionsCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {

	private Text idtext;
	private Text nametext;
	private Text desctext;
	
	public DefinitionsCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);

	}
	public DefinitionsCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
	}
