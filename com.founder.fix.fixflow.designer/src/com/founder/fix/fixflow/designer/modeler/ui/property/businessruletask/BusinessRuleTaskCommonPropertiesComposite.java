package com.founder.fix.fixflow.designer.modeler.ui.property.businessruletask;
...
public class BusinessRuleTaskCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public BusinessRuleTaskCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	public BusinessRuleTaskCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
