...
public class MessageCommonPropertiesComposite extends AbstractFixFlowBpmn2PropertiesComposite {
	private Text idtext;
	private Text nametext;
	private Text desctext;

	public MessageCommonPropertiesComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public MessageCommonPropertiesComposite(Composite parent, int style) {
		super(parent, style);
