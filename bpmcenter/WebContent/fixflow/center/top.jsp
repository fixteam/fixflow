...
<div class="header">
    ...
    <div class="menu">
        ...
        <li><a id="getMyTask" href="FlowCenter?action=getMyTask"><h1>${applicationScope.appInfo["module.schedule"]}</h1><h4>schedule</h4></a></li>
        ...
        <li><a id="getPlaceOnFile" href="FlowCenter?action=getPlaceOnFile"><h1>${applicationScope.appInfo["module.placeOnFile"]}</h1><h4>place on file</h4></a></li>
        </ul>
    </div>
</div>
<script>
