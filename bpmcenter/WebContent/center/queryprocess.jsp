...
<!-- 左 -->
	<div style="float:left;width:10%;">
	  ...
	  <a name="getInitorTask" target="_self" href="FlowCenter?action=getInitorProcess" style="display:block;">我发起的流程</a>
	  <a name="getParticipantsTask" target="_self" href="FlowCenter?action=getParticipantsProcess" style="display:block;">我参与的流程</a>
	</div>
<!-- 右-->
