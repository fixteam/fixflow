...
#Fixflow开源联盟
Fixflow开源联盟（Fixflow OpenSource Union，简称FOSU）是一个在中国使用Fixflow开源流程引擎的企业用户组成的联盟。致力于各个行业的企业用户对业务流程管理的需求，基于Fixflow开源项目平台协同研发工作，集中中国最顶尖的流程研发管理人员，使其完善，使之成为世界顶级的开源项，同时解决企业业务流程开发中的问题,为联盟成员的商业产品及社区用户提供强大底层支持。
